...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#060145] via-[#0a0a5c] to-[#060145] text-[#E9F5FF] py-10 md:py-20 px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          <h1
            data-aos="fade-down"
            data-aos-delay="200"
            className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-3 leading-tight tracking-wide"
          >
            Restaurant
          </h1>
          <h1
            data-aos="fade-up"
            data-aos-delay="400"
            className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-[#F9D91C] mb-6 leading-tight tracking-wide"
          >
            Poster Designs
          </h1>
        </div>
        ...
        <p
          data-aos="zoom-in"
          data-aos-delay="600"
          className="text-xl md:text-2xl lg:text-3xl font-light mb-6 max-w-4xl mx-auto leading-relaxed"
        >
        ...
        <p
          data-aos="fade-right"
          data-aos-delay="800"
          className="text-lg md:text-xl lg:text-2xl mb-8 max-w-3xl mx-auto opacity-90 leading-relaxed"
        >
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div
                ...
                className="flex flex-col items-center p-4 group hover:scale-105 transition-all duration-300"
              >
        ...
        >
          <button className="group bg-[#F9D91C] text-[#060145] px-8 py-4 rounded-full font-bold text-lg transition-all duration-500 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:shadow-[#F9D91C]/40 relative overflow-hidden">
          ...
          <button className="group border-2 border-[#E9F5FF] text-[#E9F5FF] px-8 py-4 rounded-full font-semibold text-lg transition-all duration-500 ease-in-out hover:bg-[#E9F5FF] hover:text-[#060145] hover:border-[#F9D91C] hover:scale-105 relative overflow-hidden">
        ...
        <p
          data-aos="fade-up"
          data-aos-delay="1800"
          className="mt-10 text-sm text-[#E9F5FF]/80"
        >
