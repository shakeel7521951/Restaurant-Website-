...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen my-10 flex items-center justify-center bg-gray-50 px-4">
      <div className="relative bg-white shadow-2xl rounded-3xl p-8 md:p-16 w-full max-w-md overflow-hidden">
        ...
        >
          ...
          <button
            type="submit"
            data-aos="zoom-in"
            className="w-full bg-[#FDC700] text-[#060145] py-3 rounded-full font-semibold shadow-lg hover:bg-yellow-500 hover:scale-105 transition-all duration-300"
          >
            Log In
          </button>
        </form>
        ...
        >
          ...
          <Link to="/signup" className="text-[#FDC700] font-semibold hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
